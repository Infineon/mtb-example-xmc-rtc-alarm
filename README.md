...
This code example demonstrates an RTC alarm interrupt of 1 minute to set a periodically blinking LED on the [XMC™ MCU evaluation kits](#supported-kits-make-variable-target).
...
Document Title: *CE232574* - *XMC MCU: RTC Alarm*
